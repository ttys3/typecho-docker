...
docker tag 80x86/lychee:AMD64-full-latest registry.cn-shenzhen.aliyuncs.com/ttys0/docker-lychee-alpine-s6:AMD64-full-latest
...
docker tag 80x86/lychee:arm64-full-latest registry.cn-shenzhen.aliyuncs.com/ttys0/docker-lychee-alpine-s6:arm64-full-latest
